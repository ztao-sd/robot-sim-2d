...
private:
	...
	const D2D1::ColorF::Enum colors[9]								
	{
		D2D1::ColorF::Yellow, D2D1::ColorF::Salmon, D2D1::ColorF::LimeGreen,
		D2D1::ColorF::Aqua, D2D1::ColorF::Beige, D2D1::ColorF::Violet, D2D1::ColorF::Azure,
		D2D1::ColorF::Crimson, D2D1::ColorF::DarkTurquoise
	};
	unsigned long long colorIndex;	

public:
	ShapeList() : shapes{}, colorIndex{ 0 } {}
	const std::unique_ptr<Shape>& SelectedShape() const;
	HRESULT InsertShape(float dipX, float dipY, Shape* shape = nullptr);
